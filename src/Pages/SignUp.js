        ...
        <FormControl onSubmit={onSave} className={classes.form}>
          <Grid container spacing={2} >
            ...
            <Grid item xs={12} sm={6}>
              <TextField id="select" label="Type of user" value={currency} name="type_of_user" required fullWidth select onChange={handleInputChange}>
            ...
            <Button fullWidth type="submit" onClick={onSave} className={classes.button} variant="contained">Sign Up</Button>
          </Grid>
        </FormControl>
      </React.Fragment>
    </AppForm>
